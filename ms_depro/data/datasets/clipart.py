...
ALL_CATEGORIES = [ # 20 classes shared with voc
     "bicycle", "bird", "car", "cat", "dog", "person", "aeroplane", "boat", "bottle", "bus", 
     "chair", "cow", "diningtable", "horse", "motorbike", "pottedplant", "sheep", "sofa", "train", "tvmonitor"
]
...
def register_clipart(dataset_root, depth):
    dataset_list = ['clipart']
    settype = ['train','test', 'all']
