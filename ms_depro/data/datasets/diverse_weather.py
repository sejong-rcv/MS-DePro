...
def register_diverse_weather(dataset_root, depth):
    dataset_list = ['daytime_sunny', 'night_clear', 'daytime_foggy', 'dusk_rainy', 'night_rainy']
    dirname_list = ['Daytime_Sunny', 'Night_Clear', 'Daytime_Foggy', 'Dusk_Rainy', 'Night_Rainy']
    settype = ['train','test']
    
    for name, dir_name in zip(dataset_list, dirname_list):
