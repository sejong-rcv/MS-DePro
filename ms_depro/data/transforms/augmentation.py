...
class AugInput:
    ...
    * The input must have a ``transform(tfm: Transform) -> None`` method which
        ...
        *,
        ...
        Args:
            image (ndarray): (H,W) or (H,W,C) ndarray of type uint8 in range [0, 255], or
                ...
                to users.
            depth_map (ndarray): (H,W) or (H,W,C) ndarray of type uint8 in range [0, 255], or
                floating point in range [0, 1] or [0, 255]. The meaning of g is geometric map.
    ...
    def transform(self, tfm: Transform) -> None:
        ...
        self.depth_map = tfm.apply_image(self.depth_map)
