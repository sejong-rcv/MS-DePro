...
class ModifiedResNet(Backbone):
    ...
    def __init__(self, layers, output_dim, heads, input_resolution=224, width=64, 
        ...
        if self.pool_vec or create_att_pool:  # pool a vector representation for an image
            ...
            self.attnpool = AttentionPool2d(input_resolution // 32, embed_dim, heads, output_dim) # input_resolution // 32: 7
...
class CLIP(Backbone):
    ...
    def forward(self, image, text):
        ...
        # normalized features
        image_features = image_features / image_features.norm(dim=-1, keeqim=True)
...
def build_clip_resnet_backbone(cfg, input_shape):
    ...
    return ModifiedResNet(
                ...
                width=vision_width,
                out_features=out_features, # ['res4']
                freeze_at=freeze_at, # 2
                depth=depth, # 50
                pool_vec=False,
                create_att_pool=create_att_pool, # True
                )
