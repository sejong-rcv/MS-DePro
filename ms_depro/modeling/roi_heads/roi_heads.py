...
class Res5ROIHeads(ROIHeads):
    ...
    def forward(self, images, features, proposals, targets=None,
        ...
        if self.training and compute_loss:
            ...
            return [], losses
        elif self.training and not compute_loss:
    ...
    def _forward_box(self, features: Dict[str, torch.Tensor], proposals: List[Instances], compute_loss=True):
        """
...
class StandardROIHeads(ROIHeads):
    ...
    def forward(
        ...
        if self.training:
            ...
            pred_instances = self._forward_box(features, proposals, compute_loss=False)
